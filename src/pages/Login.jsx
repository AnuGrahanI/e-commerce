...
//     if (!matchedUser) {
//       console.log("User not found with the provided email or phone number.");
//       return; // Prevent navigation and further actions if user not found
//     }
...
// Assuming the Redux store setup and imports are present before the Login component
